/**
 * DEFINING THEMES - Authentic Seed Data
 * 
 * This file contains researched, authentic defining themes for the Northeast region,
 * all 8 states, and can be extended for districts.
 * 
 * Each theme includes:
 * - icon: Material Symbols icon name
 * - title: Short, evocative title
 * - description: 1-2 sentence description
 * - image: { url, caption } - placeholder until CMS images uploaded
 */

// ----- REGION: NORTHEAST -----
export const NORTHEAST_THEMES = [
    {
        icon: 'terrain',
...
// Export all themes by slug for easy lookup
export const THEMES_BY_SLUG = {
