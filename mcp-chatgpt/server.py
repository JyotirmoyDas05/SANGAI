...
async def search(query: str) -> Dict[str, List[Dict[str, Any]]]:
    ...
    response = openai_client.beta.vector_stores.search(
...
async def fetch(id: str) -> Dict[str, Any]:
    ...
    content_response = openai_client.beta.vector_stores.files.content(
        vector_store_id=VECTOR_STORE_ID, file_id=id)

    # Get file metadata
    file_info = openai_client.beta.vector_stores.files.retrieve(
        vector_store_id=VECTOR_STORE_ID, file_id=id)
